...
public class ChangeFoundationSolarReflectorAbsorptanceCommand extends MyAbstractUndoableEdit {
	...
	public String getPresentationName() {
		return I18n.get("undo.absorptance_change_all") + " " + MyAbstractUndoableEdit.getPartDisplayName(reflectors.get(0).getClass()) + "s " + I18n.get("undo.on_selected_foundation");
	}
