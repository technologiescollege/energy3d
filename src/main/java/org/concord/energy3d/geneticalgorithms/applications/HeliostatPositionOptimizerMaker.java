...
public class HeliostatPositionOptimizerMaker extends OptimizerMaker {
    ...
    public void make(final Foundation foundation) {
        ...
        final JComboBox<String> solutionComboBox = new JComboBox<>(new String[]{I18n.get("combo.positions")});
        panel.add(solutionComboBox);
        panel.add(new JLabel());

        panel.add(new JLabel(I18n.get("label.objective")));
        final JComboBox<String> objectiveComboBox = new JComboBox<>(new String[]{I18n.get("combo.daily_output"), I18n.get("combo.annual_output")});
        ...
        final JDialog dialog = optionPane.createDialog(MainFrame.getInstance(), I18n.get("dialog.genetic_algorithm_options_heliostat_positions"));
