...
public class HeliostatSpiralFieldOptimizerMaker extends OptimizerMaker {
    ...
    public void make(final Foundation foundation) {
        ...
        panel.add(new JLabel(I18n.get("label.minimum_divergence_angle")));
        ...
        panel.add(new JLabel("<html><font size=2>" + I18n.get("unit.degrees") + "</font></html>"));

        panel.add(new JLabel(I18n.get("label.maximum_divergence_angle")));
        ...
        final JDialog dialog = optionPane.createDialog(MainFrame.getInstance(), I18n.get("dialog.genetic_algorithm_options_heliostat_spiral"));
            ...
            if (choice == options[1] || choice == null) {
                ...
                if (ok) {
                    if (populationSize <= 0) {
                        ...
                        JOptionPane.showMessageDialog(MainFrame.getInstance(), I18n.get("msg.divergence_angle_not_negative"), I18n.get("title.range_error"), JOptionPane.ERROR_MESSAGE);
                    } else if (minimumDivergenceAngle >= maximumDivergenceAngle) {
                        JOptionPane.showMessageDialog(MainFrame.getInstance(), I18n.get("msg.divergence_angle_max_gt_min"), I18n.get("title.range_error"), JOptionPane.ERROR_MESSAGE);
                    } else {
