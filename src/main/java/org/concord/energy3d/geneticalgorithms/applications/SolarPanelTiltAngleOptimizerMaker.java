...
public class SolarPanelTiltAngleOptimizerMaker extends OptimizerMaker {
    ...
    public void make(final Foundation foundation) {
        ...
        final JComboBox<String> solutionComboBox = new JComboBox<>(new String[]{I18n.get("combo.tilt_angles")});
        ...
        final JDialog dialog = optionPane.createDialog(MainFrame.getInstance(), I18n.get("dialog.genetic_algorithm_options_solar_panel_tilt"));
