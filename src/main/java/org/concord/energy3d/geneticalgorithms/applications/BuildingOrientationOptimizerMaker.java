...
public class BuildingOrientationOptimizerMaker extends OptimizerMaker {
    ...
    public void make(final Foundation foundation) {
        ...
        if (walls.isEmpty()) {
            JOptionPane.showMessageDialog(MainFrame.getInstance(), I18n.get("msg.no_building_on_this_foundation"), I18n.get("title.information"), JOptionPane.INFORMATION_MESSAGE);
            return;
        }
        ...
        final JComboBox<String> solutionComboBox = new JComboBox<>(new String[]{I18n.get("combo.building_orientation")});
        ...
        final JComboBox<String> convergenceCriterionComboBox = new JComboBox<String>(new String[]{I18n.get("combo.bitwise_nominal")});
        ...
        final JLabel sharingRadiusLabel = new JLabel(I18n.get("label.sharing_radius"));
        ...
        final JComboBox<String> searchMethodComboBox = new JComboBox<>(new String[]{I18n.get("combo.global_search_uniform"), I18n.get("combo.local_search_random"), I18n.get("combo.global_search_fitness")});
        ...
        final JDialog dialog = optionPane.createDialog(MainFrame.getInstance(), I18n.get("dialog.genetic_algorithm_options_building_orientation"));
            ...
            if (choice == options[1] || choice == null) {
                ...
                if (ok) {
                    if (populationSize <= 0) {
                        ...
                        JOptionPane.showMessageDialog(MainFrame.getInstance(), I18n.get("msg.sharing_radius_not_negative"), I18n.get("title.range_error"), JOptionPane.ERROR_MESSAGE);
                    } else {
