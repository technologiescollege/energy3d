...
public class ParabolicDishAnnualAnalysis extends AnnualAnalysis {
    ...
    public void show() {
        ...
        String s = null;
        int cost = -1;
        String title = I18n.get("title.annual_yield_all_parabolic_dishes", Integer.toString(Scene.getInstance().countParts(ParabolicDish.class)));
        if (selectedPart != null) {
            if (selectedPart instanceof ParabolicDish) {
                ...
                title = I18n.get("title.annual_yield_of_foundation", Integer.toString(((Foundation) selectedPart).countParts(ParabolicDish.class)), I18n.get("part.parabolic_dishes"));
            } else if (selectedPart.getTopContainer() != null) {
                title = I18n.get("title.annual_yield_of_foundation", Integer.toString(selectedPart.getTopContainer().countParts(ParabolicDish.class)), I18n.get("part.parabolic_dishes"));
            }
        }
