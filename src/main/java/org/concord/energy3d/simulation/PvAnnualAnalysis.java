...
public class PvAnnualAnalysis extends AnnualAnalysis {
    ...
    public void show() {
        ...
        String s = null;
        int cost = -1;
        String title = I18n.get("title.annual_yield_all_solar_panels", Integer.toString(Scene.getInstance().countSolarPanels()));
        if (selectedPart != null) {
            if (selectedPart instanceof SolarPanel) {
                ...
                s = selectedPart.toString().substring(0, selectedPart.toString().indexOf(')') + 1);
                title = I18n.get("title.annual_yield_solar_panels", Integer.toString(rack.getNumberOfSolarPanels()));
            } else if (selectedPart instanceof Foundation) {
                title = I18n.get("title.annual_yield_foundation_solar_panels", Integer.toString(((Foundation) selectedPart).getNumberOfSolarPanels()));
            } else if (selectedPart.getTopContainer() != null) {
                title = I18n.get("title.annual_yield_foundation_solar_panels", Integer.toString(selectedPart.getTopContainer().getNumberOfSolarPanels()));
            }
        }
