            ...
            EventQueue.invokeLater(() -> {
                ...
                if (graph instanceof BuildingEnergyAnnualGraph) {
                    ...
                    if (n > 0) {
                        ...
                        final String msg = "<html>" + I18n.get("msg.calculated_annual_net_energy", net) + "<br><hr>" + I18n.get("msg.results_from_previously_recorded_tests") + "<br>" + previousRuns + "</html>";
                        ...
                        final JDialog dialog = optionPane.createDialog(MainFrame.getInstance(), I18n.get("title.annual_net_energy"));
                        ...
                        JOptionPane.showMessageDialog(parent, "<html>" + I18n.get("msg.calculated_annual_net_energy", net) + "</html>", I18n.get("title.annual_net_energy"), JOptionPane.INFORMATION_MESSAGE);
                    }
                }
            });
            return null;
            ...
            if (graph.instrumentType == Graph.SENSOR) {
                ...
                if (selectedPart instanceof Foundation) {
                    ...
                    if (!isBuildingAcceptable((Foundation) selectedPart)) {
                        if (JOptionPane.showConfirmDialog(MainFrame.getInstance(), "<html>" + I18n.get("msg.building_not_accepted") + "</html>", I18n.get("title.unacceptable_building"), JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE) != JOptionPane.YES_OPTION) {
                            return;
                        }
                    }
