...
public class HeliostatDailyAnalysis extends DailyAnalysis {
    ...
    public void show() {
        ...
        String s = null;
        int cost = -1;
        String title = I18n.get("title.daily_yield_all_heliostats", Integer.toString(Scene.getInstance().countParts(Mirror.class)));
        if (selectedPart != null) {
            if (selectedPart instanceof Mirror) {
                ...
                title = I18n.get("title.daily_yield_of_foundation", Integer.toString(((Foundation) selectedPart).countParts(Mirror.class)), I18n.get("part.heliostats"));
            } else if (selectedPart.getTopContainer() != null) {
                title = I18n.get("title.daily_yield_of_foundation", Integer.toString(selectedPart.getTopContainer().countParts(Mirror.class)), I18n.get("part.heliostats"));
            }
        }
